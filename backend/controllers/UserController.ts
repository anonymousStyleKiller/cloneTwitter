...
import {IUserModalDocument, IUserModel, UserModel} from "../models/UserModel";
...
class UserController {
            ...
            res.json({
                ...
                data: {
                    ...
                    token: jwt.sign({data: req.user},
                        process.env.SECRET_KEY || "QWERT123",
                        {expiresIn: "30 days"}),
                }
            });
        } catch (error) {
    ...
    async create(req: express.Request, res: express.Response): Promise<void> {
        try {
            ...
            sendEmail({emailFrom: "admin@twitter.com", emailTo: data.email,
